-- This was made by 𝐻𝒶𝓂𝓅𝑒#0706 and 𝓈𝓀𝓊𝓁𝓁𝓎#2888
-- Bloxtality.win was inspired by Fatality.win

getgenv().values = {}
local library = loadstring(game:HttpGet'https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua')()
library:CreateWatermark("Bloxtality | V1.0.0 | ".. game.Players.LocalPlayer.Name..'')
...
local cfglocation = "Bloxtalitycfg/" 
makefolder("Bloxtalitycfg") 
...
function library:New(name) 
	...
	local Bloxtality = INST("ScreenGui") 
	...
	Bloxtality.Name = "electric boogalo" 
	Bloxtality.ResetOnSpawn = false 
	Bloxtality.ZIndexBehavior = "Global" 
	Bloxtality.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = Bloxtality 
	...
	but.Parent = Bloxtality 

	local cursor = INST("ImageLabel") 
	cursor.Name = "cursor" 
	cursor.Parent = Bloxtality 
	...
	game:GetService("RunService").RenderStepped:connect(function() 
		cursor.Visible = Bloxtality.Enabled 
		cursor.Position = UDIM2(0,Mouse.X-3,0,Mouse.Y+1) 
	end) 

	Menu.Name = "Menu" 
	Menu.Parent = Bloxtality 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			Bloxtality.Enabled = not Bloxtality.Enabled 
			library.uiopen = Bloxtality.Enabled 
		end 
	end) 
	...
	function menu:Tab(text) 
		...
		function Tab:MSector(text, side) 
			...
			Section.BackgroundColor3 = COL3RGB(64, 64, 64) 
			Section.BorderColor3 = COL3RGB(64, 64, 64) 
			...
			function MSector:Tab(text) 
				...
				tab1.BorderColor3 = COL3RGB(64, 64, 64) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Button.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						Drop.BorderColor3 = COL3RGB(64, 64, 64) 
					...
					elseif type == "ToggleKeybind" then 
						...
						do 
							...
							Keybind.BorderColor3 = COL3RGB(64, 64, 64) 
							...
							Frame.BorderColor3 = COL3RGB(64, 64, 64) 
							...
							Always.BorderColor3 = COL3RGB(64, 64, 64) 
							...
							Hold.BorderColor3 = COL3RGB(64, 64, 64) 
							...
							Toggle.BackgroundTransparency = 1.000 
							Toggle.BorderColor3 = COL3RGB(64, 64, 64) 
					...
					elseif type == "Toggle" then 
						...
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(33, 35, 47) 
						Color.BorderColor3 = COL3RGB(64, 64, 64) 
						Color.Position = UDIM2(0, 15, 0.5, -5) 
						Color.Size = UDIM2(0, 8, 0, 8) 
					...
					elseif type == "ToggleColor" then 
						...
						ColorP.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						Colorpick.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						ColorDrag.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						Huepick.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						Huedrag.BorderColor3 = COL3RGB(64, 64, 64) 
					...
					elseif type == "ToggleTrans" then 
						...
						Transpick.BorderColor3 = COL3RGB(64, 64, 64) 
						...
						Transdrag.BorderColor3 = COL3RGB(64, 64, 64) 
					...
					elseif type == "Button" then 
						...
						Button_2.BorderColor3 = COL3RGB(64, 64, 64) 
		...
		function Tab:Sector(text, side) 
			...
			Inner.Parent = Section 
			Inner.BackgroundColor3 = COL3RGB(30, 30, 39) 
			Inner.BorderColor3 = COL3RGB(64, 64, 64) 
			Inner.BorderSizePixel = 0 
			Inner.Position = UDIM2(0, 1, 0, 1) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				elseif type == "ToggleKeybind" then      
					...
					Element.value = {Toggle = data.default and data.default.Toggle or false, Key, Type = "Always", Active = true}                                                                                                                                                                                                                                                                               -- PASTED FROM BLOXTALITY.WIN MADE BY 𝐻𝒶𝓂𝓅𝑒#0706 AND 𝓈𝓀𝓊𝓁𝓁𝓎#2888
				...
				elseif type == "TextBox" then 
					...
					TextBox.BorderColor3 = COL3RGB(64, 64, 64) 
	...
	Bloxtality.Parent = game.CoreGui 
...
local gui = library:New("Bloxtality") 
...
antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "random", "custom", "bloxtality", "Random AA", "God", "fucker"}})
...
movement:Element("ToggleKeybind", "edge bug") 
	local zuhnmode = Instance.new("ColorCorrectionEffect", workspace.CurrentCamera)
		...
		Text.Name = "Text"                                                                                                                                                                                                                                                                                                                                                          -- EZ PASTA FROM YTILATXOLB BUT BACKWARDS
	...
	if PlayerIsAlive then 
		...
		if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then 
			if values.rage.aimbot.enabled.Toggle then 
				...
				for _,Player in pairs(Players:GetPlayers()) do 
					...
					spawn(function()
						if Player.Character and Player.Character:FindFirstChild("Humanoid") and Player.Character:FindFirstChild("Humanoid").Health > 20 and Player.Team ~= "TTT" and Player ~= LocalPlayer then      
							if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "Pitch") then      
								Player.Character.UpperTorso.Waist.C0 = CFAngles(2, 3, 6)      
								Player.Character.LowerTorso.Root.C0 = CFAngles(1,4,9)
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then
			...
			Root.CFrame = YROTATION(CFramePos)
                ...
                local Pitch = values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "bloxtality" and -6 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-10, 10)/10 or values.rage.angles["pitch"].Dropdown == "custom" and values.rage.angles["pitch angle"].Slider or values.rage.angles["pitch"].Dropdown == "huge" and math.huge or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "Random AA" and RANDOM(-1362, 2337)/5078 or values.rage.angles["pitch"].Dropdown == "God" and 15 or 2.5
                if values.rage.angles["extend pitch"].Toggle and (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down" or values.rage.angles["pitch"].Dropdown == "bloxtality" or values.rage.angles["pitch"].Dropdown == "180") then 
                    Pitch = (Pitch*2)/1.6 
                end 
...
mt.__namecall = function(self, ...) 
	...
	if method == "FindPartOnRayWithWhitelist" and not checkcaller() and Client.gun ~= "none" and Client.gun.Name ~= "C4" then 
		if #args[2] == 1 and args[2][1].Name == "SpawnPoints" then 
			...
			if TBLFIND(values.misc.client.shop.Jumbobox, "anywhere") then                                                                                                                                                                                                                                                                                                                                                       -- 𝐻𝒶𝓂𝓅𝑒#0706 AND 𝓈𝓀𝓊𝓁𝓁𝓎#2888 ON TOP
